...
int lujin[]={12,
	...
	611,8359,221,8270,
	43,190,44,221,45,190,422,
	8180,11,188,221,890,11,188,222,8181,555,
	190,46,190,471,190,481,190,42,
	

	611,8270,222,8180,12,
	43,190,44,221,45,190,422,	
	891,555,49,190,50,190,51,190,42,
	...
	43,190,44,221,45,190,422,
	890,11,188,221,
	555,49,190,50,190,51,190,42,//0
	
	611,8271,11,188,221,8360,11,
	43,190,44,221,45,190,422,
	221,890,12,188,221,8181,555,
	190,46,190,471,190,481,190,42,
  0};
...
/********************************************/
/**************PID参数*************************/	
	Chassis_Speed_kpid[LEFT_FRON_201][KP] = 5.5;//11
	Chassis_Speed_kpid[LEFT_FRON_201][KI] = 0.01;//100;90
	Chassis_Speed_kpid[LEFT_FRON_201][KD] = 0;
	
	Chassis_Speed_kpid[RIGH_FRON_202][KP] = 4;//15
	Chassis_Speed_kpid[RIGH_FRON_202][KI] = 0.01;//0.08;0
	Chassis_Speed_kpid[RIGH_FRON_202][KD] = 0;
	
	Chassis_Speed_kpid[LEFT_BACK_203][KP] = 5.5;//11//19
	Chassis_Speed_kpid[LEFT_BACK_203][KI] = 0.01;//0.08;0
	Chassis_Speed_kpid[LEFT_BACK_203][KD] = 0;
	
	Chassis_Speed_kpid[RIGH_BACK_204][KP] = 5.5;//15
...
{
	float k_rc_z=1;
	kRc_Mech_Chassis_Standard = 7.5f;  //调节摇杆灵敏度,调节速度
	kRc_Mech_Chassis_Revolve  = 10.f; //调节机械模式摇杆扭头灵敏度(太小会影响最高速度)
	...
	if(fabs(Chassis_Move_Z) > 800)//扭头速度越快,前后速度越慢,防止转弯半径过大
		...
		float fb_offset = constrain_float( kRc_Mech_Chassis_Standard*RC_CH3_LUD_OFFSET, -Chassis_Standard_Move_Max*k_rc_z, Chassis_Standard_Move_Max*k_rc_z);//前后
...
float Chassis_GetOffsetAngle(fp32 angle)
{
	...
	if( fabs(Target_Angle - Cloud_Angle_Measure_Yaw) <= 0.95 )
	{
		sAngleError = 0;
	}
	else
